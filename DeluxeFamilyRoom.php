...
<header>
    ...
    <div class="slideshow-container">
        ...
        <div class="slide">
            <img src="https://hotelmaluri.com/wp-content/uploads/2022/06/sldr-famr01.jpg" alt="">
        </div>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 3 Queen Size Bed
                </td>
                <td>
                ...
                <td>
                    <span class="price-strike">RM 659.55</span><br>
                    <b style="color: red;">RM 515.75</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                    <button class="choose-btn" onclick="showForm('Deluxe Family Room no Breakfast include', 'RM 515.75')">Choose</button><br>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <b>Deluxe Family Room</b> <br>
                    Breakfast included for 4 people <br>
                    Non-refundable<br>
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 3 Queen Size Bed
                </td>
                <td>
                ...
                <td>
                    <span class="price-strike">RM 689.50</span><br>
                    <b style="color: red;">RM 525.75</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                    <button class="choose-btn" onclick="showForm('Deluxe Family Room for 6 people Breakfast', 'RM 525.75')">Choose</button><br>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <b>Deluxe Family Room</b><br>
                    Special Breakfast included for 6 people<br>
                    Non-refundable<br>
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 3 Queen Size Bed
                </td>
                <td>
                ...
                <td>
                    <span class="price-strike">RM 729.55</span><br>
                    <b style="color: red;">RM 555.43</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                    <button class="choose-btn" onclick="showForm('Deluxe Family Room for 6 people Special Breakfast', 'RM 555.43')">Choose</button>
                </td>
            </tr>
