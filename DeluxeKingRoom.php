...
<header>
    ...
    <div class="slideshow-container">
        ...
        <div class="slide">
            <img src="https://ik.imagekit.io/tvlk/generic-asset/Ixf4aptF5N2Qdfmh4fGGYhTN274kJXuNMkUAzpL5HuD9jzSxIGG5kZNhhHY-p7nw/hotel/asset/20009953-5e62ab3d5bba980bbb896e4529b8da86.jpeg?_src=imagekit&tr=c-at_max,f-jpg,h-460,pr-true,q-80,w-724" alt="">
        </div>
    ...
    <p style="text-align: center; margin: 20px; color: #555;">
        Our simple yet comfortable Deluxe King Room features a King Size Bed, a separate seating area with table and chairs as well as a modern bathroom with walk-in shower. The spacious room is decorated with traditional Malaysian artwork and textiles and is perfect for a business traveller or a couples getaway.
    </p>
    ...
    <div class="container">
        <table>
            ...
            <tr>
                <td>
                    <b>Deluxe King Room</b><br>
                    No Breakfast included <br>
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 1 King Bed
                </td>
                <td>
                    <img src="https://cdn-icons-png.flaticon.com/512/1946/1946429.png" alt="Guest icon" width="15px">
                </td>
                <td>
                    <span class="price-strike">RM 301.54</span><br>
                    <b style="color: red;">RM 200</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                    <button class="choose-btn" onclick="showForm('Deluxe Single King Bed Room no Breakfast included', 'RM 200')">Choose</button><br>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <b>Deluxe King Room</b> <br>
                    Breakfast included for 1 people <br>
                    Non-refundable<br>
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 1 King Bed
                </td>
                <td>
                ...
                <td>
                    ...
                    <b style="color: red;">RM 225.50</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                <button class="choose-btn" onclick="showForm('Deluxe Single King Bed Room with 1 person Breakfast included', 'RM 225.50')">Choose</button><br>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <b>Deluxe King Room</b><br>
                    Special Breakfast included for 2 people<br>
                    Non-refundable<br>
                    <img src="https://icons.veryicon.com/png/o/object/home-icon/bed-7.png" alt="Bed icon" width="15px"> 1 King Bed
                </td>
                <td>
                ...
                <td>
                    <span class="price-strike">RM 347.88</span><br>
                    <b style="color: red;">RM 250.50</b><br>
                    <small>Include taxes & fees</small><br>
                </td>
                <td>
                    <button class="choose-btn" onclick="showForm('Deluxe Sigle King Bed Room with 2 people Breakfast included', 'RM 250.50')">Choose</button><br>
                </td>
            </tr>
    ...
    <div class="overlay" id="formOverlay">
        <div class="form-container">
            ...
            <form id="payment-form" action="confirmation.php" method="POST">
                ...
                <input type="date" id="checkinDate" name="checkinDate" required> </b>br>
